...
console.log('Sostituzione delle date individuali per ogni singolo articolo...');
...
console.log('✅ Date individuali sostituite per ogni articolo!');
console.log('📅 Ora ogni articolo ha la sua data specifica nella preview');
