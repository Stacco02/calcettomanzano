...
console.log('Sostituzione diretta delle date...');
...
const replacedCount = (newsContent.match(/Data non disponibile/g) || []).length;
const finalCount = (updatedContent.match(/Data non disponibile/g) || []).length;
