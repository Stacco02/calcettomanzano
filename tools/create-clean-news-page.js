						...
						<article class="news-card" style="background: #fff; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); overflow: hidden; transition: transform 0.2s;">
							...
							<div class="news-card-content" style="padding: 1.5rem;">
								<h3 class="news-title" style="margin: 0 0 1rem 0; font-size: 1.25rem; font-weight: 600;">
									<a href="Blog_new/${article.originalFile}" style="color: #1e40af; text-decoration: none;">${article.title}</a>
								</h3>
								...
								<a href="Blog_new/${article.originalFile}" class="news-read-more" style="display: inline-block; background: #f59e0b; color: #1e40af; padding: 8px 16px; border-radius: 8px; text-decoration: none; font-weight: 500; font-size: 14px;">Leggi articolo</a>
							</div>
						</article>`;
}
